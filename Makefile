...
node_modules/web-tree-sitter:
	git clone --depth 1 --branch $(TREE_SITTER_VERSION) https://github.com/tree-sitter/tree-sitter.git tmp/tree-sitter
...
tree-sitter-haskell.wasm: src/exports.json src/parser.c src/scanner.cc
	emcc                                           \
